...
will be using the `mycliproject-userX` that you created in the
...
image::images/scale_up.jpg[image]

right next to the pod count circle to
add 2 more pods.
...
image::images/scale_down.jpg[image]

twice to remove 2 running pods.
