...
....
$ oc new-project myjbossapp-userX --display-name="My JBoss Applications" --description="A place for my JBoss EAP Applications"
....
...
`$ curl ks-myjbossapp-userX.{routing-suffix}`
....
<!--
...
Go to https://ks-myjbossapp-userX.{routing-suffix} via your browser.
