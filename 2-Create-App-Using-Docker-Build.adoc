...
(https://github.com/kwkoo/time). The `centos` folder from this github
project is built starting with centos7 as the base image which is
described in Dockerfile. Look at the Dockerfile for this project. It
starts off with `centos:7` image. It copies the
...
....
$ oc new-app https://github.com/kwkoo/time --context-dir=centos

--> Found Docker image 9f38484 (3 months old) from Docker Hub for "centos:7"

    * An image stream tag will be created as "centos:7" that will track the source image
    * A Docker build using source code from https://github.com/kwkoo/time will be created
    ...
    * WARNING: Image "centos:7" runs as the 'root' user which may not be permitted by your cluster administrator
...

{
    ...
    "metadata": {
        ...
        "creationTimestamp": "2019-06-21T08:11:45Z",
        "labels": {
            "app": "time"
        },
        "name": "time",
        "namespace": "mycliproject-user1",
        "resourceVersion": "61556",
        "selfLink": "/apis/build.openshift.io/v1/namespaces/mycliproject-user1/buildconfigs/time",
        "uid": "35815583-93fc-11e9-be73-02b5cd18489e"
    },
    "spec": {
        ...
        "source": {
            "contextDir": "centos",
            "git": {
                "uri": "https://github.com/kwkoo/time"
            },
            "type": "Git"
        },
        "strategy": {
        ...
        "triggers": [
            {
                "github": {
                    "secret": "M8FxIISXRH0TU9F4B7PD"
                },
                "type": "GitHub"
            },
            {
                "generic": {
                    "secret": "UddCzXALpJtOXnY7YgrZ"
                },
                "type": "Generic"
            },
            {
            ...
            {
                "imageChange": {
                    "lastTriggeredImageID": "centos@sha256:ca58fe458b8d94bc6e3072f1cfbd334855858e05e1fd633aa07cf7f82b048e66"
                },
                "type": "ImageChange"
            }
        ]
    ...
    "items": [
        {
            ...
            "metadata": {
                ...
                "name": "time",
                "namespace": "mycliproject-user1",
                "resourceVersion": "61662",
                "selfLink": "/apis/apps.openshift.io/v1/namespaces/mycliproject-user1/deploymentconfigs/time",
                "uid": "3582e7da-93fc-11e9-be73-02b5cd18489e"
            },
            "spec": {
                "replicas": 1,
                ...
                "template": {
                    ...
                    "spec": {
                        "containers": [
                            {
                                "image": "docker-registry.default.svc:5000/mycliproject-user1/time@sha256:2260d0b21f93118cc68fa82091ff1e29c9b060283ed0deaf5ebeab70482c21c5",
                ...
                "triggers": [
                    ...
                    },
                    {
                        "imageChangeParams": {
                            ...
                            "lastTriggeredImage": "docker-registry.default.svc:5000/mycliproject-user1/time@sha256:2260d0b21f93118cc68fa82091ff1e29c9b060283ed0deaf5ebeab70482c21c5"
                        },
                        "type": "ImageChange"
                    }
                ]
            ...
            "status": {
                ...
                "conditions": [
                    {
                        "lastTransitionTime": "2019-06-21T08:12:04Z",
                        "lastUpdateTime": "2019-06-21T08:12:04Z",
                        "message": "Deployment config has minimum availability.",
                        "status": "True",
                        "type": "Available"
                    },
                    {
                        "lastTransitionTime": "2019-06-21T08:12:05Z",
                        "lastUpdateTime": "2019-06-21T08:12:05Z",
...
time      time-mycliproject-user1.apps.sgp-16ff.openshiftworkshop.com             time       8080-tcp                 None
....
...
....
$ curl time-mycliproject-user1.apps.sgp-16ff.openshiftworkshop.com
