...
Type in the master public URL (`{master-url}`) in a browser.
...
1.  Open https://hawkular-metrics.{routing-suffix}/hawkular/metrics from a new tab on the same
broswer
2.  Click ''Advanced'' link
3.  Click ''Proceed to hawkular-metrics.{routing-suffix} (unsafe)''
